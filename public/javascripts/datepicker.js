    ...
    Plugin.prototype =
        {
            ...
            initTemplate: function () {
                ...
                this.template = '<div class="dtp hidden" id="' + this.name + '">' +
                    ...
                    '<div class="dtp-close"><a href="javascript:void(0);"><i class="glyphicon glyphicon-remove-sign"></i></a></div>' +
                    '</header>' +
                    '<div class="dtp-date hidden">' +
                    '<div>' +
                    '<div class="left center p10">' +
                    '<a href="javascript:void(0);" class="dtp-select-month-before"><i class="glyphicon glyphicon-menu-left"></i></a>' +
                    '</div>' +
                    '<div class="dtp-actual-month p80">MAR</div>' +
                    '<div class="right center p10">' +
                    '<a href="javascript:void(0);" class="dtp-select-month-after"><i class="glyphicon glyphicon-menu-right"></i></a>' +
                    '</div>' +
                    ...
                    '<div>' +
                    '<div class="left center p10">' +
                    '<a href="javascript:void(0);" class="dtp-select-year-before"><i class="glyphicon glyphicon-menu-left"></i></a>' +
                    '</div>' +
                    '<div class="dtp-actual-year p80' + (this.params.year ? '' : ' disabled') + '">2014</div>' +
                    '<div class="right center p10">' +
                    '<a href="javascript:void(0);" class="dtp-select-year-after"><i class="glyphicon glyphicon-menu-right"></i></a>' +
                    '</div>' +
                    '<div class="clearfix"></div>' +
                    '</div>' +
                    '</div>' +
                    ...
                    '<button class="dtp-btn-cancel btn btn-flat btn-big">' + this.params.cancelText + '</button>' +
                    '<button class="dtp-btn-ok btn btn-flat btn-big">' + this.params.okText + '</button>' +
                    '<div class="clearfix"></div>' +
                    '</div>' +
                    '</div>' +
                    '</div>';
